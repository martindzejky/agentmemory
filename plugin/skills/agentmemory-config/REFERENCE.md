...
Configuration is read from the environment and from `~/.agentmemory/.env` (no `export` prefix). 53 recognized variables:

- `AGENTMEMORY_AGENT_SCOPE`
- `AGENTMEMORY_ALLOW_AGENT_SDK`
- `AGENTMEMORY_AUTO_COMPRESS`
- `AGENTMEMORY_COMMIT_SHA`
- `AGENTMEMORY_COMPRESS_UPGRADE_GRACE_MS`
...
- `AGENTMEMORY_ENGINE_WATCHDOG_MS`
- `AGENTMEMORY_ENRICH_BUDGET_MS`
- `AGENTMEMORY_EXPORT_ROOT`
- `AGENTMEMORY_FOLLOWUP_WINDOW_SECONDS`
- `AGENTMEMORY_FORCE_PROXY`
- `AGENTMEMORY_GRAPH_SEARCH`
- `AGENTMEMORY_GRAPH_SEARCH_BUDGET_MS`
- `AGENTMEMORY_GRAPH_SEARCH_MAX_SEEDS`
...
- `AGENTMEMORY_SEARCH_CONCURRENCY`
- `AGENTMEMORY_SECRET`
- `AGENTMEMORY_SESSION_ID`
- `AGENTMEMORY_SLOTS`
- `AGENTMEMORY_SUMMARY_REBUILD_INTERVAL`
...
- `AGENTMEMORY_VIEWER_PROXY_SECRET`
